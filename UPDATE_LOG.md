...
2026年6月14日：
1. 更新版本v1.2.1
2. 新增 删除好友 命令，仅主人可用，用于批量清除某个好友的所有订阅信息


2026年2月20日：
1. 更新版本v1.2.0
2. 优化自动关注逻辑，解决由于bot账号被某个账号拉黑导致自动关注任务被打断，导致队列中剩余账号无法继续执行关注任务
...
2025年9月7日：
1. 更新版本v1.1.8
2. 优化重载逻辑，能够将最新昵称写入数据库
3. 新增 status 命令，可以展示当前starbot版本，套用starbot3.0的回复格式

2025年8月9日：
1. 更新版本v1.1.7
2. 修复bug:从mysql数据源重载未开通直播间的up主时，会导致未捕获异常无法发出成功反馈截图

2025年6月11日：
1. 更新版本v1.1.6
2. 实现新需求，现在可以通过 设置直播报告 命令来关闭和开启直播报告本身，同步更新其帮助指令
